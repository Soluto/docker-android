...
ENV PATH $PATH:$ANDROID_HOME/tools:$ANDROID_HOME/platform-tools:$ANDROID_HOME/build-tools/25.0.0:$ANDROID_HOME/build-tools/23.0.2:$ANDROID_HOME/build-tools/23.0.1:$ANT_HOME/bin:$MAVEN_HOME/bin
